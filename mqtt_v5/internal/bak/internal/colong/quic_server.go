...
type Server struct {
	...
	sharePubFunc func(msg interface{}) error // 其它节点发来sharePub消息
	// 客户端或者服务端的连接数据
	Svc *ColongSvc
	// 客户端名称
	Name string
...
func (this *Server) ListenAndServe(uri string, pubFunc, sysFuc, sharePubFunc func(msg interface{}) error) error {
