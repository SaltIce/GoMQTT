...
//func (this *Server) Publish(msg *PublishMessage, onComplete OnCompleteFunc) error {
...
//func (this *Server) handleConnection(ctx context.Context, c io.Closer) (svc *ColongSvc, err error) {
//	if c == nil {
